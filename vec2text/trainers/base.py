...
class BaseTrainer(transformers.Trainer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.metric_accuracy = evaluate.load("/home/yiruo_cheng/huggingface/evaluate/metrics/accuracy")
        self.metric_bleu = evaluate.load("/home/yiruo_cheng/huggingface/evaluate/metrics/sacrebleu")
        # self.metric_bertscore = evaluate.load("bertscore")
        self.metric_rouge = evaluate.load("/home/yiruo_cheng/huggingface/evaluate/metrics/rouge")
